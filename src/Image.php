...
class Image extends \DOTNET
{
     ...
     * making transparent areas opaque and opaque areas transparent.Different images within the mask can be accessed
     * using the Frame property. Different portions of the mask can be selected using the Selection property.Note that
     * transparency is only applied to an Image if the Indirect property is true (which is generally the case).
     *
