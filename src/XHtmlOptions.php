 ...
 * @property Integer $RepaintDelay Minimum time to wait for the page to finish animation (ms).
...
class XHtmlOptions extends \DOTNET
{
    ...
    /**
     * This method scans the entire document converting external links
     * to internal links wherever possible.By default, links in rendered HTML are preserved as is. This means
     ...
     * the link displayed.In some situations, you may wish to resolve links within the document
